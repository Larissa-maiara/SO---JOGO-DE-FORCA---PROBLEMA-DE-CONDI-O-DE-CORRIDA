...
class Forca:
    def __init__(self, palavra):
        ...
        self.vencedor = None
        self.lock = threading.Lock()  # Lock para proteger seções críticas. Garantir que apenas uma tread consiga acessar e alterar a palavra por vez. 

    def chutar(self, letra, posicao, jogador_nome):
        with self.lock:  # Permitir verificação e atualização da palavra sem interferencia das threads.
            letra = letra.upper()
